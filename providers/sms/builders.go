...
// SMSBuilder interface defines the contract for all SMS builders
type SMSBuilder interface {
	// NewTextMessage creates a new text SMS message
	NewTextMessage(mobiles []string, content string, opts ...MessageOption) *Message
	// NewMMSMessage creates a new MMS (multimedia) message
	NewMMSMessage(mobiles []string, opts ...MessageOption) *Message
	// NewVoiceMessage creates a new voice message
	NewVoiceMessage(mobiles []string, content string, opts ...MessageOption) *Message
}
